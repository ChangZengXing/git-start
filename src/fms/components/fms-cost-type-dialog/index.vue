  ...
  export default {
    ...
    methods: {
      async open(dialogParams) {
        console.log('fms-cost-type-dialog open', dialogParams)
        this.dialogOpen()
        this.dialogParams = { ...dialogParams }
        const { costType } = dialogParams
        this.loadData(costType)
      },
      dialogOpen() {
      ...
      async loadData(costType) {
        console.log('costType', costType)
        try {
          this.loading = true
          const res = await this.$$getCostType(costType)
