<template>
  <el-form-item
    class="fms-form-items"
    :rules="rules || col.rules || undefined"
    :prop="prop || col.key"
    :labelWidth="labelWidth || col.labelWidth || 'auto'"
    :labelPosition="labelPosition || col.labelPosition"
  ...
  >
    ...
    <template v-for="(col, i) in itemsComputed">
      <fms-components :key="col.key + i" :col="col" :model="model" @input="input"/>
    </template>
  </el-form-item>
</template>
